...
public class DocumentSave {
    ...
    public static DocumentSave saveOrUpdate(Long originalRequestId, Long templateId, String fileUrl) {
        ...
        Optional<DocumentSave> existingDoc = documentSaveRepository.findByIdAndTemplateId(originalRequestId,
                templateId);
        ...
        if (existingDoc.isPresent()) {
            ...
            System.out.println(
                    String.format("Updating existing DocumentSave entry in DB for Request ID '%d', Template ID '%d'.",
            ...
            System.out.println(
                    String.format("Creating new DocumentSave entry in DB for Request ID '%d', Template ID '%d'.",
                            originalRequestId, templateId));
        }
